...
> **Canonical root source.** Every music, ambience, SFX, vocal-stab, mix, mastering, AudioMixer, snapshot, transition, and audio-accessibility change must read this file. The Unity-side document under `Assets/_Project/Design/Audio/` is a synchronized mirror for in-editor discovery.

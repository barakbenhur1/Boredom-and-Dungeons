...
namespace BoredomAndDungeons
{
    public sealed partial class BDModernHandheld3DPresenter
    {
            ...
            Material chairMaterial)
        {
            ...
            float backPanelBottomY = CinematicChairSeatSurfaceY + 0.52f;
            ...
            float lowerBackRailHalfHeight = 0.17f;
            float topRailHalfHeight = 0.23f;
            float slatBottomY =
                backPanelBottomY + lowerBackRailHalfHeight;
            float slatTopY =
                backPanelTopY - topRailHalfHeight;
            float slatYCenter = (slatBottomY + slatTopY) * 0.5f;

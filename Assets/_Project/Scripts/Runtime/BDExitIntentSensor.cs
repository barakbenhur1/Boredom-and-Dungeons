...
namespace BoredomAndDungeons
{
    ...
    public sealed class BDExitIntentSensor : MonoBehaviour
    {
        [SerializeField] private BDCombatRoom combatRoom;
        [SerializeField] private Transform exitAnchor;
        [SerializeField] private float notifyEverySeconds = 0.10f;
        ...
        private void TryNotify(Collider other)
        {
            ...
            if (combatRoom == null || exitAnchor == null)
                return;
            ...
            combatRoom.NotifyExitIntent(exitAnchor);
        }
    }
}

...
namespace BoredomAndDungeons.EditorTools.Validation
{
    internal static class BDV23R9HorseArtDirectionQA
    {
        public static void Scan(BDOneClickQAResult result)
        {
            ...
            Require(result, root, "Assets/_Project/Design/Horse/HORSE_CONTEXT_ACTION_PROMPTS_V1.md", "V23R9_HORSE_PROMPT_DESIGN_MISSING", "State matrix", "Mounted and moving", "Healing is available only on foot");
            Require(result, root, "ART_DIRECTION.md", "V23R9_ROOT_ART_DIRECTION_DOCUMENT_MISSING", "Canonical root source", "65% colorful wonder", "35% mystery and danger", "Game Boy menu shell", "True victory transformation", "fantasy display font", "Game Boy-inspired game icons", "smooth elegance with physical weight", "Mounted and stationary", "Mounted and moving");
            Require(result, root, "Assets/_Project/Design/Visual/ART_DIRECTION_AND_INTERFACE_CONVENTIONS_V1.md", "V23R9_ART_DIRECTION_MIRROR_MISSING", "Canonical root source", "ART_DIRECTION.md");
            RequireFile(result, root, "Assets/_Project/Design/Visual/References/BOREDOM_AND_DUNGEONS_ART_DIRECTION_REFERENCE_BOARD_V1.jpg", "V23R9_ART_REFERENCE_BOARD_MISSING");
            Require(result, root, "DOCUMENTATION_INDEX.md", "V23R9_DOCUMENTATION_INDEX_MISSING", "ART_DIRECTION_AND_INTERFACE_CONVENTIONS_V1.md", "BOREDOM_AND_DUNGEONS_ART_DIRECTION_REFERENCE_BOARD_V1.jpg");
            Require(result, root, "PROJECT_STATUS.md", "V23R9_PROJECT_STATUS_MISSING", "C04/C11/C12.RUNTIME.V23R9", "V23R8 automated QA passed", "Saved feature resume point");
        }

...
- `Assets/_Project/Design/Visual/ART_DIRECTION_AND_INTERFACE_CONVENTIONS_V1.md` owns the durable visual language for stylized 3D form, materials, textures, color, lighting, HUD, prompts, typography, iconography, effects, animation feel, and responsive desktop/mobile presentation.
...
- Root `AUDIO_DIRECTION.md` owns music identity, state hierarchy, mixer routing, loudness/mastering, and transition rules.
...
- `AUDIO_DIRECTION.md` is the canonical event-coverage and mix contract; complete runtime production remains C12.42.

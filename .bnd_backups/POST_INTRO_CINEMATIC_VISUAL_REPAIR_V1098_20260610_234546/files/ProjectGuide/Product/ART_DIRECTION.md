...
## Post-intro physical product direction V10.9.6

Read the handheld as a small portable object resting by gravity on full-size premium furniture. Its portrait face is horizontal against the tabletop, not presented as a kiosk or display stand. The opening must immediately communicate the table's real scale; the final close view is earned only by camera approach.

The device contact shadow follows its small horizontal footprint. Wood grain, tabletop thickness, leg scale, perspective and lighting remain coherent. Screen readability comes from a high, downward-looking camera and restrained lens—not from enlarging or standing the device. The BBH fade may reveal only the intended establishing frame; a flash of the final menu composition is a visible defect.

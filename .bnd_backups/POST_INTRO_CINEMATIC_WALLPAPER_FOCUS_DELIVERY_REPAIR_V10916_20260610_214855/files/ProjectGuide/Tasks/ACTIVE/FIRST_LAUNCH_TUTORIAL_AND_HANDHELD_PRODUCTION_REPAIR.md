...
## V10.9.13 active QA repair

The active task remains the post-intro focused-room cinematic. Automated validation is blocked by an aggregate scanner omission, not by missing DOF implementation. Add the DOF source file to the aggregate runtime read, rerun `TEST EVERYTHING`, and then resume visual review. Do not change the V10.9.12 camera, room, device or focus implementation in this repair.

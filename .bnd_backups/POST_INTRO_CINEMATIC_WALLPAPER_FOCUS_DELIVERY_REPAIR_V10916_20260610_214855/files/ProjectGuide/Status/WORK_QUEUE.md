...
## Current immediate gate — V10.9.13

1. Apply the DOF aggregate-QA repair over installed V10.9.12.
2. Wait for Unity compilation.
3. Run `Boredom And Dungeons -> TEST EVERYTHING`.
4. Require `PASS | blockers=0, warnings=0, info=0`.
5. Continue the V10.9.12 visual review of close framing, forward placement, room dressing and device-focused depth of field.
6. Do not commit or advance to the retro tutorial redesign before automated PASS and visual acceptance.

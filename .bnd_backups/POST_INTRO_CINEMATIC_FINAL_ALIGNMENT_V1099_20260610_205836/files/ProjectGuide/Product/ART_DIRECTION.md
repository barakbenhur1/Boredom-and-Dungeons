...
## Post-intro product-shot correction V10.9.8

The rejected screenshots are not an acceptable product composition: the handheld may not dominate half of the furniture, sink into the wood, or be photographed from a grazing angle that stretches and crops the display. The final image must read as a genuinely portable object on a full-size premium table. Use the fixed physical scale and a higher downward camera; never enlarge or tilt the object to make the screen readable.

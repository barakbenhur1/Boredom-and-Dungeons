    ...
    public sealed partial class BDModernHandheld3DPresenter
    {
        ...
        private void PrimeIntroToMainMenuFirstFrame()
        {
            ...
            introToMainMenuStartFieldOfView = Mathf.Clamp(
                introToMainMenuFinalFieldOfView + 9.0f,
                24f,
                28f
            );

...
namespace BoredomAndDungeons
{
    public sealed partial class BDModernHandheld3DPresenter
    {
        ...
        private void BuildCinematicProductEnvironment()
        {
            ...
            Material wallpaperMaterial = CreateCinematicWallpaperMaterial(
                "BD Cinematic Kitchen Wallpaper",
                new Color(0.83f, 0.79f, 0.73f, 1f),
                new Color(0.62f, 0.49f, 0.39f, 1f),
                new Color(0.93f, 0.88f, 0.80f, 1f)
            );
            ...
            Material wallpaperMaterial)
        {
            ...
            BuildCinematicWallpaperPanels(wallpaperMaterial);
        ...
        private void BuildCinematicWallpaperPanels(Material wallpaperMaterial)
        {
            CreateCinematicCube(
                ...
                tableRoot,
                new Vector3(0f, -2.1f, 22.30f),
                new Vector3(31.5f, 16.2f, 0.06f),
                wallpaperMaterial,
                castShadows: false,
                receiveShadows: true
            );
            CreateCinematicCube(
                "Cinematic Kitchen Wallpaper Left Wall",
                tableRoot,
                new Vector3(-15.65f, -2.0f, 13.6f),
                new Vector3(0.06f, 16.0f, 18.0f),
                wallpaperMaterial,
                castShadows: false,
                receiveShadows: true
            );
            CreateCinematicCube(
                "Cinematic Kitchen Wallpaper Right Wall",
                tableRoot,
                new Vector3(15.65f, -2.0f, 13.6f),
                new Vector3(0.06f, 16.0f, 18.0f),
                wallpaperMaterial,
            ...
            Color accentColor)
        {
            ...
            texture.name = materialName + " Texture";
            ...
            for (int y = 0; y < texture.height; y++)
            {
                for (int x = 0; x < texture.width; x++)
                {
                    ...
                    float diamondU = Mathf.Abs((u * 4f) % 1f - 0.5f);
                    float diamondV = Mathf.Abs((v * 4f) % 1f - 0.5f);
                    if (diamondU + diamondV < 0.18f)
                    {
                        pixel = Color.Lerp(baseColor, motifColor, 0.82f);
                    }

                    float flowerU = (u * 8f) % 1f - 0.5f;
                    float flowerV = (v * 8f) % 1f - 0.5f;
                    if (flowerU * flowerU + flowerV * flowerV < 0.018f)
                    {
                        pixel = accentColor;
                    }

                    if (Mathf.Abs(((u * 4f) % 1f) - 0.5f) < 0.020f ||
                        Mathf.Abs(((v * 4f) % 1f) - 0.5f) < 0.020f)
                    {
                        pixel = Color.Lerp(pixel, motifColor, 0.28f);
                    }
            ...
            material.mainTextureScale = new Vector2(8f, 5f);

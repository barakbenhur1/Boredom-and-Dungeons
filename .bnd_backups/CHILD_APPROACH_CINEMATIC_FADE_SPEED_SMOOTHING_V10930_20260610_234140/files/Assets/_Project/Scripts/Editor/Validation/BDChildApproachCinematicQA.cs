    ...
    internal static class BDChildApproachCinematicQA
    {
        public static void Scan(BDOneClickQAResult result)
        {
            ...
            RequireTokens(
                ...
                "ChildApproachWalkEndsAtSeconds = 3.65f",
                "ChildApproachClimbStartsAtSeconds = 4.10f",
                "ChildApproachSeatReachSeconds = 5.85f",
                "ChildApproachCameraSettleSeconds = 6.75f",
                "ChildApproachPowerOnStartsAtSeconds = 7.00f",
                "ChildApproachPowerOnEndsAtSeconds = 8.05f",

...
## V10.9.22 active QA alignment

The active task remains the post-intro cinematic. The visual implementation is preserved; only stale automated camera contracts are aligned with V10.9.21. Obtain `TEST EVERYTHING 0/0/0`, then continue visual acceptance without changing Runtime in this repair.

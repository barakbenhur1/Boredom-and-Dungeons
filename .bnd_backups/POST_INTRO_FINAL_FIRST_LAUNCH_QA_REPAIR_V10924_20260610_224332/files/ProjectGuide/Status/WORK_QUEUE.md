...
## Current immediate gate — V10.9.22

1. Apply the QA-only contract alignment over installed V10.9.21.
2. Let Unity compile.
3. Run `Boredom And Dungeons -> TEST EVERYTHING`.
4. Require `PASS | blockers=0, warnings=0, info=0`.
5. Resume visual review of the exact fruit wallpaper, room depth, full-device final framing, and subtle DOF.

...
## V10.9.5 table-scene orientation and physical-scale contract

The term “upright/portrait handheld” describes the device's industrial form and UI orientation, not its pose on the table. In the post-intro table scene the device must **lie flat on the tabletop**. It may not be stood vertically for product-display convenience.

### Reference physical dimensions

| Object | Width / long axis | Depth / short axis | Height / thickness |
|---|---:|---:|---:|
| Handheld | 14–16 cm long | 8–10 cm wide | 2–3 cm thick |
| Full table | 140–180 cm wide | 75–90 cm deep | 72–76 cm high |

Project units may differ, but the visible ratios must remain credible:

- handheld long axis: about 8–12% of table width;
- handheld short axis: about 9–14% of table depth;
- device thickness and tabletop thickness must both remain readable at suitable angles;
- the device sits around the approved central/rear-middle tabletop zone without approaching the table edges unnaturally.

The device, table and shadow hierarchy use one stable physical scale and transform throughout the cinematic and ordinary menu state. No scale animation, upright-rest substitution, hidden table resizing or transform restore is allowed. Screen readability is owned by camera placement and lens/framing.

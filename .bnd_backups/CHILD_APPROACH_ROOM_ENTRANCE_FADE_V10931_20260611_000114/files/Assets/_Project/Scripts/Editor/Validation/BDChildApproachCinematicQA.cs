    ...
    internal static class BDChildApproachCinematicQA
    {
        public static void Scan(BDOneClickQAResult result)
        {
            ...
            RequireTokens(
                ...
                "ChildApproachWalkEndsAtSeconds = 3.45f",
                "ChildApproachClimbStartsAtSeconds = 3.78f",
                "ChildApproachSeatReachSeconds = 5.10f",
                "ChildApproachCameraSettleSeconds = 6.02f",
                "ChildApproachPowerOnStartsAtSeconds = 6.18f",
                "ChildApproachPowerOnEndsAtSeconds = 7.20f",

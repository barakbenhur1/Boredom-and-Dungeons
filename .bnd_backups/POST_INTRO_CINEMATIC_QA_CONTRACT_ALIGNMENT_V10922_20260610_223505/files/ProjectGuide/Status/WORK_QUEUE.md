...
## Current gate — V10.9.21

1. Apply V10.9.21.
2. Wait for Unity compilation.
3. Run `Boredom And Dungeons -> TEST EVERYTHING`; require `0/0/0`.
4. Verify exact fruit wallpaper, no visible side walls/slat overlay, believable wall distance, subtle DOF, and full-device final framing.
5. Commit and push only after automated PASS and visual approval.

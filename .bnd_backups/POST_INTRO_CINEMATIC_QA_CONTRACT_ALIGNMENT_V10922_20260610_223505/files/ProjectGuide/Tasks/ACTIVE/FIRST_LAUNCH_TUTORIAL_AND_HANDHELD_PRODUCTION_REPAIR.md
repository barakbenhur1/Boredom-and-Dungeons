...
## V10.9.21 active implementation

The active task remains the post-intro cinematic. This pass safely delivers the supplied back-wall wallpaper and final framing without rewriting existing environment method bodies.

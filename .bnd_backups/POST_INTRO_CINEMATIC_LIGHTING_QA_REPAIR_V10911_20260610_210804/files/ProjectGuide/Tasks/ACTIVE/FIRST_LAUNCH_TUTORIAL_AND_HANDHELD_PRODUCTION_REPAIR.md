...
## V10.9.10 active compile-blocker repair

The active cinematic task remains unchanged, but visual validation is temporarily blocked by a generated QA syntax error from V10.9.9. Repair the illegal trailing method-call comma in both focused QA files, recompile, obtain `TEST EVERYTHING 0/0/0`, and then resume the pending visual confirmation of the device's forward placement and direct original-menu final angle. No runtime or art change belongs to this repair.

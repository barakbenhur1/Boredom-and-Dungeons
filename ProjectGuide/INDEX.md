...
- [`Rules/TERMINAL_OUTPUT_STANDARD.md`](Rules/TERMINAL_OUTPUT_STANDARD.md)
...
- [`Tasks/QUEUED/FIRST_LAUNCH_TUTORIAL_RETRO_VISUAL_REDESIGN.md`](Tasks/QUEUED/FIRST_LAUNCH_TUTORIAL_RETRO_VISUAL_REDESIGN.md)
- [`Tasks/QUEUED/NEW_ENEMY_ARCHETYPES_ARTICULATED_MODELS_AND_DIFFICULTY_GRAPH.md`](Tasks/QUEUED/NEW_ENEMY_ARCHETYPES_ARTICULATED_MODELS_AND_DIFFICULTY_GRAPH.md)
...
## Tutorial production course and saved-run contracts

- [`QA/FIRST_LAUNCH_TUTORIAL_PRODUCTION_COURSE_V10.md`](QA/FIRST_LAUNCH_TUTORIAL_PRODUCTION_COURSE_V10.md)
- [`Features/Runtime/PERSISTENT_RUN_RESUME_AND_ABANDON_SCORING_V1.md`](Features/Runtime/PERSISTENT_RUN_RESUME_AND_ABANDON_SCORING_V1.md)
- [`Tasks/QUEUED/PERSISTENT_RUN_RESUME_EXIT_AND_ABANDON_SCORING.md`](Tasks/QUEUED/PERSISTENT_RUN_RESUME_EXIT_AND_ABANDON_SCORING.md)

The superseded tutorial V3/V4/V5 correction-only QA files are merged into the canonical feature and V10 QA contract and should not remain indexed as current owners.
<!-- BND_FIRST_LAUNCH_TUTORIAL_PRODUCTION_COURSE_V10:END -->

<!-- BND_FIRST_LAUNCH_TUTORIAL_ENTRY_GATE_V103:BEGIN -->
## V11 first-launch entry and animation contract

- [`Features/UI/FIRST_LAUNCH_TUTORIAL_ENTRY_AND_ANIMATION_V11.md`](Features/UI/FIRST_LAUNCH_TUTORIAL_ENTRY_AND_ANIMATION_V11.md)
<!-- BND_FIRST_LAUNCH_TUTORIAL_ENTRY_GATE_V103:END -->

<!-- BND_FIRST_LAUNCH_TUTORIAL_PROGRESSION_GATE_REPAIR_V104:BEGIN -->
## Tutorial V10.4 QA contract

- [`QA/FIRST_LAUNCH_TUTORIAL_V104_PROGRESSION_GATE_REPAIR.md`](QA/FIRST_LAUNCH_TUTORIAL_V104_PROGRESSION_GATE_REPAIR.md)
...
## V10.5 intro cinematic contracts

- [`Features/UI/INTRO_TO_MAIN_MENU_CINEMATIC_V1.md`](Features/UI/INTRO_TO_MAIN_MENU_CINEMATIC_V1.md)
- [`QA/INTRO_TO_MAIN_MENU_CINEMATIC_V105_QA.md`](QA/INTRO_TO_MAIN_MENU_CINEMATIC_V105_QA.md)
<!-- BND_INTRO_TO_MAIN_MENU_CINEMATIC_AND_TUTORIAL_SPACING_V105:END -->

<!-- BND_BBH_GLOBAL_TIMESCALE_REMOVAL_V106:BEGIN -->
## V10.6 QA contract

- [`QA/BBH_GLOBAL_TIMESCALE_REMOVAL_V106.md`](QA/BBH_GLOBAL_TIMESCALE_REMOVAL_V106.md)
...
- [`Rules/TERMINAL_OUTPUT_STANDARD.md`](Rules/TERMINAL_OUTPUT_STANDARD.md)
- [`QA/POST_INTRO_HANDHELD_LANDING_TRANSITION_V1072_QA.md`](QA/POST_INTRO_HANDHELD_LANDING_TRANSITION_V1072_QA.md)

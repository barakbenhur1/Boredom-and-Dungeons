...
This document defines mandatory production-animation coverage for the shipped game and complements the canonical visual language in `ProjectGuide/Product/ART_DIRECTION.md`.
